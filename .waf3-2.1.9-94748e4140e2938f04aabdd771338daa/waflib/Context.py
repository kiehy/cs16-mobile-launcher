...
HEXVERSION=0x2010900
"""Constant updated on new releases"""

WAFVERSION="2.1.9"
"""Constant updated on new releases"""

WAFREVISION="387d01ca6097d1a50f42b82d1b562913c8a0e2b6"
...
class Context(ctx):
	...
	def exec_command(self, cmd, **kw):
		...
		output_prefix = kw.pop('output_prefix', '')
		...
		if output_prefix and (out or err):
			# clear the progress bar on stderr before printing task output
		...
		if out:
			...
			if self.logger:
				...
				Logs.info(output_prefix + out, extra={'stream':sys.stdout, 'c1': ''})
		if err:
			...
			if self.logger:
				...
				Logs.info(output_prefix + err, extra={'stream':sys.stderr, 'c1': ''})

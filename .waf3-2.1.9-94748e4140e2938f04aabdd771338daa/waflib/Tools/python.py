...
def check_python_headers(conf, features='pyembed pyext'):
	...
	* PYEMBED: for embedding a python interpreter
	...
	v = 'prefix SO EXT_SUFFIX LDFLAGS LIBDIR LIBPL INCLUDEPY Py_ENABLE_SHARED MACOSX_DEPLOYMENT_TARGET LDSHARED CFLAGS LDVERSION Py_GIL_DISABLED'.split()
	try:
	...
	if env.CC_NAME == "msvc":
		...
		# On Windows, Py_GIL_DISABLED must be defined manually, see https://docs.python.org/3/howto/free-threading-extensions.html
		if dct['Py_GIL_DISABLED'] == '1':
			env.append_value('CFLAGS_PYEXT', ['/DPy_GIL_DISABLED=1'])
			env.append_value('CXXFLAGS_PYEXT', ['/DPy_GIL_DISABLED=1'])

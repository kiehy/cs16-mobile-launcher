...
@feature('c', 'cxx', 'd', 'fc', 'asm', 'includes')
...
def accept_node_to_link(self, node):
	...
	"""
	return node.suffix() not in ('.pdb', '.d')
...
@feature('c', 'cxx', 'd', 'fc', 'asm', 'javac', 'cs', 'uselib')
...
@feature('cshlib', 'cxxshlib', 'fcshlib', 'asmshlib')
...
@feature('cshlib', 'cxxshlib', 'dshlib', 'fcshlib', 'asmshlib', 'vnum')

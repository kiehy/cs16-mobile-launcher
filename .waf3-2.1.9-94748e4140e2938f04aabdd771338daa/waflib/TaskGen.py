...
class task_gen(object):
	...
	* The attribute 'idx' is a counter of task generators in the same path
	...
	def create_task(self, name, src=None, tgt=None, **kw):
		...
		:type src: list of :py:class:`waflib.Node.Node`
		:param tgt: output nodes
		:type tgt: list of :py:class:`waflib.Node.Node`
...
def before_method(*k):
	"""
	Decorator that registers task generator methods which will be executed
...
def to_nodes(self, lst, path=None):
	...
	:type path: :py:class:`waflib.Node.Node`
